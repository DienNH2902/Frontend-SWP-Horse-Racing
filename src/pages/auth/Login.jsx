      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        .gh-options {
          ...
          justify-content: space-between;
          gap: 16px;
          margin: 0 0 clamp(10px, 1.7vh, 22px);
          font-size: 15px;
        }
        ...
        .gh-divider {
          ...
          align-items: center;
          gap: 22px;
          margin: clamp(10px, 1.9vh, 26px) 0;
        ...
        .gh-google-btn {
          ...
          gap: 14px;
          border: 1px solid rgba(2, 38, 35, 0.12);
          color: #14211f;
          background: #fff;
        ...
        <aside className="gh-form-panel">
          ...
          <div className="gh-form-wrap">
            <h1 className="gh-title">
              Welcome Back
              <span>to GoldenHoof</span>
            </h1>
            <p className="gh-subtitle">
              Sign in to access your account and stay updated with the world of
              horse racing.
            </p>
            ...
            <section className="gh-shell">
                <aside className="gh-form-panel">
                    ...
                    <div className="gh-form-wrap">
                        ...
                        <form onSubmit={handleLogin}>                            <div className="gh-field">
